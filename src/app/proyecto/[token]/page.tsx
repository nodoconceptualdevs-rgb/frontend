...
export default function ProyectoPage() {
  ...
  const handleGoBack = () => {
    ...
    switch (roleType) {
      case ROLES.ADMIN:
        // Admin va a /admin/proyectos
        router.push('/admin/proyectos');
        break;
      case ROLES.GERENTE_PROYECTO:
        // Gerente va a /admin/proyectos (porque tiene acceso al admin de proyectos)
        router.push('/admin/proyectos');
        break;
      case ROLES.CLIENT:
        // Cliente va a /dashboard/mi-proyecto
        ...
        <div className="container mx-auto px-4 py-6 max-w-6xl">
          ...
          <div className="mb-4">
            ...
            >
              ...
              {isAuthenticated ? 'Volver a Proyectos' : 'Ir al Login'}
            </button>
          </div>
...
/**
 * Visor de PDF - Diseño con botones en esquina superior y preview interno
 */
function VisorPDF({ url, nombre }: { url: string; nombre: string }) {
  ...
  return (
    <>
      <div className="relative rounded-xl overflow-hidden border border-gray-200 bg-white shadow-sm">
        ...
        <div className="absolute top-3 right-3 z-10 flex gap-2">
          <button
            ...
            className="p-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg shadow-lg transition-all duration-200 hover:scale-105"
            title="Ver PDF"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            ...
            disabled={isLoading}
            className="p-2 bg-green-600 hover:bg-green-700 text-white rounded-lg shadow-lg transition-all duration-200 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
            title="Descargar PDF"
          >
            {isLoading ? (
        ...
        <div className="relative bg-gray-50">
          <iframe
            src={`${pdfUrl}#toolbar=1&navpanes=0&scrollbar=1&zoom=85`}
            className="w-full h-[600px] border-0"
            title={`Vista de ${nombre}`}
          ...
          {previewError && (
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-gray-50">
              ...
              <p className="text-gray-500 text-sm mb-2">No se pudo cargar el PDF</p>
              <button
                onClick={handleViewPDF}
      ...
      {/* Modal para mostrar PDF completo */}
      {showPDFModal && (
        <div 
